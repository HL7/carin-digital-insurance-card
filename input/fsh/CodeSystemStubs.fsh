...
* ^publisher = "HL7 International - Payer/Provider Information Exchange"
* ^contact[0].name = "HL7 International - Payer/Provider Information Exchange"
* ^contact[0].telecom[0].system = #url
* ^contact[0].telecom[0].value = "http://www.hl7.org/Special/Committees/claims"
* ^contact[0].telecom[1].system = #email 
* ^contact[0].telecom[1].value = "pie@lists.hl7.org"
...
* codes from system $FDANationalDrugCode
* include C4DICCompoundLiteral#compound 
...
// 20210201 CAS: https://jira.hl7.org/browse/FHIR-30413 - Add HIPPS to Institutional item.productOrService Value Set
// Approach adding a special valueset for inpatient
ValueSet: C4DICEOBInstitutionalProcedureCodes
// 20210215 CAS: FHIR-31074 - Please shorten the titles for the IP, OP, and Professional Procedure code and modifiers ValueSets
