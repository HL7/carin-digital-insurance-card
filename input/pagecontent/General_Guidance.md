...
The Digital Insurance Card can be shared by a consumer in flexible ways. See [Authorization](/Use_Case_Authorizatin.html) and [Distribution](/Use_Case_Distribution.html) to learn more.
...
- **SHALL** follow the [SMART Health Cards specification]({{site.data.fhir.ver.shcl}}) to create a SMART Health Card containing the FHIR bundle.
  - **SHALL** create the SMART Health Card as a JWS string, as defined by [{{site.data.fhir.ver.shcl}}/cards-specification.html]({{site.data.fhir.ver.shcl}}/cards-specification.html).
  - **SHOULD** implement revocation as defined by [{{site.data.fhir.ver.shcl}}]({{site.data.fhir.ver.shcl}}/card-specification.html#revocation).

- **SHALL** follow the [SMART Health Links specification]({{site.data.fhir.ver.shcl}}) to create a SMART Health Link referencing the SMART Health Card.
...
- **SHALL** share the Digital Insurance Card with the member as other personal information would be shared.
 - **SHALL** provide the member the SMART Health Link in text URI format as well as   QR format, as described here [{{site.data.fhir.ver.shcl}}/cards-spcificatin.html#presenting-health-cards-to-a-verifier]({{site.data.fhir.ver.shcl}}/cards-spcificatin.html#presenting-health-cards-to-a-verifier).
...
- **SHALL** inform the user if the card has been revoked, as specified by [{{site.data.fhir.ver.shcl}}/card-specification.html#revocation]({{site.data.fhir.ver.shcl}}/card-specification.html#revocation).
...
- **SHALL** provide the member with the ability to share the SMART Health Link as they see fit.
  - **SHALL** provide the member the SMART Health Link in text URI format as well as QR code, as described here [{{site.data.fhir.ver.shcl}}/links-specification.html]({{site.data.fhir.ver.shcl}}/links-specification.html).
